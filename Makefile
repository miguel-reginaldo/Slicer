...
# translation
SOURCES = slicer.py slicer_form.py __init__.py slicerdialog.py
#TRANSLATIONS = i18n/slicer_pt_BR.ts
TRANSLATIONS =
...
PY_FILES = slicer.py slicerdialog.py  __init__.py

EXTRAS = icon.png metadata.txt

UI_FILES = slicer_form.py 
